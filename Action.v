...
const actions_names = ['None', 'Quit the game', 'Start the game', 'Pause', '+ players nbs',
	...
	'- center player 1', '+ center player 1', 'Change sens player 1', '- center player 3',
	'+ center player 2', 'Change sens player 2', '- center player 3', '+ center player 3',
	'Change sens player 3']
...
fn (mut app App) settings_render() {
	for ind in 1 .. 10 {
		if ind + app.pause_scroll < actions_names.len {
			...
			y := int(100 + ind * 40)
			app.text_rect_render(x, y, (actions_names[ind + app.pause_scroll] + ': ' +
				key_code_name[app.list_action_key_code[ind + app.pause_scroll]]), 255)

			x2 := int(3 * app.win_width / 4)
			app.gg.draw_circle_filled(x2, y + 15, boutons_radius, gg.gray)
		}
	}
}
